...
`;
  ...
  // New section
  html += buildEmailSection_("New Alerts", newRows, "new");
  
  // Updated section
  html += buildEmailSection_("Updated Alerts", updatedRows, "updated");
  
  // Ongoing section
  html += buildEmailSection_("Ongoing Alerts", ongoingRows, "ongoing");
  
  html += `
<div class="footer">
Automated report by HMI LiveRamp Alerts Tracker | Questions? <a href="mailto:${ERROR_EMAIL}">${ERROR_EMAIL}</a>
</div>
</body>
</html>
`;
...
function buildEmailSection_(title, rows, sectionClass) {
